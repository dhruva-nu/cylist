...
"""Changing the board's shape, on a path that names the project."""

SHAPE_THIS_BOARD = guards.for_entity(Permission.BOARD, resolved_column)
"""The same, reached through one of the board's own columns."""
